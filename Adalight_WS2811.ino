...
#define NUM_LEDS     34 //226         // number of LED *controllers* (WS82811/WS2801 has 3 LEDs _per controller_, WS2812B has one LED per controller)
...
#define IDLE_EFFECT_SPEED 'S'    // speed of the lightshow effects: 'S' = slow, 'N' = normal, 'F' = fast, 'T' = trippy
// -------------------------------------------------------------------
// -------------------------------------------------------------------
